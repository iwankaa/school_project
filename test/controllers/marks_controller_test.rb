...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference("Mark.count") do
      post marks_url, params: { mark: { student_id: @mark.student_id, subject: @mark.subject } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { student_id: @mark.student_id, subject: @mark.subject } }
